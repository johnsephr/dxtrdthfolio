const work = [
    {
        title: 'Harmony',
        industry: 'Infrastructure Monitoring',
    ...
    },
    {
        title: 'The Night Sky',
        industry: 'eCommerce',
        summary: 'My brother and I redesigned and rebuilt The Night Sky\'s create app from near scratch. The app allows users to intuitively design their Night Sky poster with a live render of their changes. Utilizing Redux and Axios, I created an efficient flow of information between the front and back end. We also designed and created for them an admin app, which allows administrative personel to view and modify existing orders, as well as view charts containing relevant demographics.',
        roles: ['Front-End Web Developer'],
        icons: ['react', 'redux'],
        image: 'tns'
    },
